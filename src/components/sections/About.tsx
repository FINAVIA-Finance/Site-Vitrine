...
import {Award, CheckCircle2, Rocket, Users} from 'lucide-react';
...
const About = () => {
  return (
    <section className="py-16 px-6 bg-[#07036e] text-white relative overflow-hidden">
      <FloatingStars color="white"/>

      {/* Decorative Blur Circle */}
      <div
        className="absolute top-0 right-0 w-[500px] h-[500px] bg-[#e51990] rounded-full blur-[120px] opacity-20 translate-x-1/2 -translate-y-1/2 pointer-events-none"/>
      ...
      <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-16 items-center relative z-10">
        ...
        >
          ...
          <h2 className="text-4xl md:text-5xl font-extrabold mb-6 leading-tight">
            Le partenaire de votre <br/> transformation financière
          </h2>
          <p className="text-white/80 text-lg leading-relaxed font-light">
            Finavia combine expertise finance de terrain, exécution opérationnelle, maîtrise des outils et
            IA appliquée.
          </p>
          <p className="text-white/80 text-lg leading-relaxed mb-8 font-light">
            Nous ne livrons pas des recommandations théoriques : nous structurons les process,
            déployons les outils et intégrons l’IA là où elle crée un impact réel, pour une fonction finance
            plus fiable, plus rapide et réellement pilotable.
          </p>
