  ...
  return (
    ...
    >
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        >
          <span
            className="text-[#e51990] font-bold text-sm uppercase tracking-wider bg-white/10 px-4 py-1 rounded-full">
                  ...
                  >
                    ...
                    <div className="p-8 flex-grow flex flex-col">
                      ...
                      <div className="pt-4 border-t border-gray-100">
                        <Link href="https://calendly.com/contact-finavia/30min" target="_blank"
                              rel="noopener noreferrer"
                              className="text-[#e51990] font-bold flex items-center gap-2 hover:gap-3 transition-all uppercase text-sm tracking-wide">
